...
if(isset($_POST['update'])) {    
    ...
    if($msg != null) {
        ...
        $valid['success'] = true;
        $valid['messages'] = "Andamento Atualizado.";

        //echo json_encode($valid);
		
        echo "<script type='text/javascript'>alert(\"Andamento Atualizado.\");
              window.location = 'http://localhost:8080/juridico/editarAndamento.php?o=manpro&i=$id_processo';
              </script>";
...
if(isset($_POST['finaliza'])) {    
	...
	$result = $crud->execute("Update tb_andamento set st_andamento = 2
           ...
           echo "<script type='text/javascript'>alert(\"Andamento Encerrado.\");
              window.location = 'http://localhost:8080/juridico/editarAndamento.php?o=manpro&i=$id_processo';
              </script>";
