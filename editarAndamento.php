...
<!----------------------------------------------------------------------------->    
    ...
    $sql = "SELECT id_andamento,id_processo,nu_processo, dt_andamento, tp_andamento,ds_andamento, st_andamento
            FROM andamento_listar where id_Processo ={$idprocesso} ";
...
<!----------------------------------------------------------------------------->    
    ...
    //while($res = mysqli_fetch_array($result)) {         
	   ...
	   // <a href=\"atualizarAndamento.php?id=$res[id_andamento]\">Editar</a> | <a href=\"delAndamento.php?id=$res[id_andamento]\" 
	   // onClick=\"return confirm('Confirma a exclusão do andamento?')\">Remover</a></td> </div>";     
	  ...
	  <button type='button' class='btn btn-default dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
	    ...
	    <li><a href='atualizarAndamento.php?id=$res[id_andamento]' id='editOrderModalBtn'> <i class='glyphicon glyphicon-edit'></i> Editar</a></li>
			...
			//<li><a href='delAndamento.php?id=$res[id_andamento]' id='removeOrderModalBtn'> <i class='glyphicon glyphicon-trash'></i> Excluir</a></li>
